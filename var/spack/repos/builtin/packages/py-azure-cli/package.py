...
class PyAzureCli(PythonPackage):
    ...
    version("2.20.0", sha256="29ce24866e0f2bf64978f2a203cd5a5cfec19a6521d82f5ec7a9fb7e44fa99bc")
...
with when("@2.20.0:"):
        depends_on("py-setuptools", type="build")
        depends_on("py-antlr4-python3-runtime@4.7.2:4.7", type=("build", "run"))
        #depends_on("py-azure-appconfiguration@1.1.1:1.1", type=("build", "run"))
        depends_on("py-azure-batch@10.0", type=("build", "run"))
        depends_on("py-azure-cli-core@2.20")
        depends_on("py-azure-cosmos@3.0.2:3", type=("build", "run"))
        depends_on("py-azure-datalake-store@0.0.49:0.0", type=("build", "run"))
        depends_on("py-azure-functions-devops-build@0.0.22:0.0", type=("build", "run"))
        depends_on("py-azure-graphrbac@0.60", type=("build", "run"))
        depends_on("py-azure-keyvault@1.1:1", type=("build", "run"))
        #depends_on("py-azure-keyvault-administration@4.0.0", type=("build", "run"))
        depends_on("py-azure-mgmt-advisor@2.0.1:2", type=("build", "run"))
        depends_on("py-azure-mgmt-apimanagement@0.2", type=("build", "run"))
        depends_on("py-azure-mgmt-applicationinsights@0.1.1:0.1", type=("build", "run"))
        depends_on("py-azure-mgmt-appconfiguration@1.0.1:1.0", type=("build", "run"))
        depends_on("py-azure-mgmt-authorization@0.61", type=("build", "run"))
        depends_on("py-azure-mgmt-batch@9.0", type=("build", "run"))
        depends_on("py-azure-mgmt-batchai@2", type=("build", "run"))
        depends_on("py-azure-mgmt-billing@1.0.0", type=("build", "run"))
        depends_on("py-azure-mgmt-botservice@0.3", type=("build", "run"))
        depends_on("py-azure-mgmt-cdn@7.0.0", type=("build", "run"))
        depends_on("py-azure-mgmt-cognitiveservices@6.3", type=("build", "run"))
        depends_on("py-azure-mgmt-compute@19.0", type=("build", "run"))
        depends_on("py-azure-mgmt-consumption@2", type=("build", "run"))
        depends_on("py-azure-mgmt-containerinstance@1.4:1", type=("build", "run"))
        depends_on("py-azure-mgmt-containerregistry@3.0.0rc14", type=("build", "run"))
        depends_on("py-azure-mgmt-cosmosdb@3.0", type=("build", "run"))
        depends_on("py-azure-mgmt-containerservice@9.4", type=("build", "run"))
        #depends_on("py-azure-mgmt-databoxedge@0.2", type=("build", "run"))
        depends_on("py-azure-mgmt-datalake-analytics@0.2.1:0.2", type=("build", "run"))
        depends_on("py-azure-mgmt-datalake-store@0.5", type=("build", "run"))
        depends_on("py-azure-mgmt-datamigration@4.1", type=("build", "run"))
        depends_on("py-azure-mgmt-deploymentmanager@0.2", type=("build", "run"))
        depends_on("py-azure-mgmt-devtestlabs@4", type=("build", "run"))
        depends_on("py-azure-mgmt-dns@2.1:2", type=("build", "run"))
        depends_on("py-azure-mgmt-eventgrid@3.0.0rc7", type=("build", "run"))
        depends_on("py-azure-mgmt-eventhub@4.1", type=("build", "run"))
        depends_on("py-azure-mgmt-hdinsight@2.2", type=("build", "run"))
        depends_on("py-azure-mgmt-imagebuilder@0.4", type=("build", "run"))
        depends_on("py-azure-mgmt-iotcentral@4.1", type=("build", "run"))
        depends_on("py-azure-mgmt-iothub@0.12", type=("build", "run"))
        depends_on("py-azure-mgmt-iothubprovisioningservices@0.2", type=("build", "run"))
        depends_on("py-azure-mgmt-keyvault@8.0.0", type=("build", "run"))
        depends_on("py-azure-mgmt-kusto@0.3", type=("build", "run"))
        depends_on("py-azure-mgmt-loganalytics@8.0", type=("build", "run"))
        depends_on("py-azure-mgmt-managedservices@1", type=("build", "run"))
        depends_on("py-azure-mgmt-managementgroups@0.1:0", type=("build", "run"))
        depends_on("py-azure-mgmt-maps@0.1", type=("build", "run"))
        depends_on("py-azure-mgmt-marketplaceordering@0.1:0", type=("build", "run"))
        depends_on("py-azure-mgmt-media@3", type=("build", "run"))
        depends_on("py-azure-mgmt-monitor@2.0", type=("build", "run"))
        depends_on("py-azure-mgmt-msi@0.2:0", type=("build", "run"))
        depends_on("py-azure-mgmt-netapp@0.15", type=("build", "run"))
        depends_on("py-azure-mgmt-network@17.1", type=("build", "run"))
        depends_on("py-azure-mgmt-policyinsights@0.5", type=("build", "run"))
        depends_on("py-azure-mgmt-privatedns@0.1", type=("build", "run"))
        depends_on("py-azure-mgmt-rdbms@3.1.0", type=("build", "run"))
        depends_on("py-azure-mgmt-recoveryservices@0.4", type=("build", "run"))
        depends_on("py-azure-mgmt-recoveryservicesbackup@0.11", type=("build", "run"))
        depends_on("py-azure-mgmt-redhatopenshift@0.1.0", type=("build", "run"))
        depends_on("py-azure-mgmt-redis@7.0", type=("build", "run"))
        depends_on("py-azure-mgmt-relay@0.1", type=("build", "run"))
        depends_on("py-azure-mgmt-reservations@0.6.0", type=("build", "run"))
        # depends_on("py-azure-mgmt-resource=12.0.0", type=("build", "run"))
        depends_on("py-azure-mgmt-search@8", type=("build", "run"))
        depends_on("py-azure-mgmt-security@0.6", type=("build", "run"))
        depends_on("py-azure-mgmt-servicebus@0.6", type=("build", "run"))
        depends_on("py-azure-mgmt-servicefabric@0.4", type=("build", "run"))
        depends_on("py-azure-mgmt-signalr@0.26", type=("build", "run"))
        depends_on("py-azure-mgmt-sql@0.26", type=("build", "run"))
        depends_on("py-azure-mgmt-sqlvirtualmachine@0.5", type=("build", "run"))
        depends_on("py-azure-mgmt-storage@17.0", type=("build", "run"))
        depends_on("py-azure-mgmt-trafficmanager@0.51", type=("build", "run"))
        depends_on("py-azure-mgmt-web@0.48", type=("build", "run"))
        # dpeends_on("py-azure-mgmt-synapse@0.6", type=("build", "run"))
        depends_on("py-azure-multiapi-storage@0.6", type=("build", "run"))
        depends_on("py-azure-loganalytics@0.1", type=("build", "run"))
        depends_on("py-azure-storage-common@1.4", type=("build", "run"))
        depends_on("py-azure-synapse-accesscontrol@0.2", type=("build", "run"))
        depends_on("py-azure-synapse-artifacts@0.3", type=("build", "run"))
        depends_on("py-azure-synapse-spark@0.2", type=("build", "run"))
        depends_on("py-fabric@2.4:2", type=("build", "run"))
        depends_on("py-jsmin@2.2.2:2.2", type=("build", "run"))
        depends_on("py-pytz@2019.1", type=("build", "run"))
        depends_on("py-scp@0.13.2:0.13", type=("build", "run"))
        depends_on("py-sshtunnel@0.1.4:0.1", type=("build", "run"))
        depends_on("py-urllib3@1.25.9:1+secure", type=("build", "run"))
        depends_on("py-vsts-cd-manager@1.0.2:1.0", type=("build", "run"))
        depends_on("py-websocket-client@0.56", type=("build", "run"))
        depends_on("py-xmltodict@0.12:0", type=("build", "run"))
        depends_on("py-javaproperties@0.5.1", type=("build", "run"))
        depends_on("py-jsondiff@1.2.0", type=("build", "run"))
